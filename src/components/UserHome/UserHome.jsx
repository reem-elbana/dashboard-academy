  ...
  <div className="space-y-12">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 mb-12">
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
        ...
        <p className="text-3xl font-bold text-gray-900 mt-2">{stats?.profile_completion || 0}%</p>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
        ...
        <p className="text-3xl font-bold text-green-600 mt-2">
          {stats?.has_valid_subscription ? t("active") : t("inactive")}
        </p>
        <p className="text-xs text-gray-500 mt-2">
          Expires: {stats?.subscription_expires_at ? new Date(stats.subscription_expires_at).toLocaleDateString("en-GB") : "--"}
        </p>
      </div>
    </div>

    {/* 3. جلسات الأسبوع الحالي + الحضور الأخير جنب بعض */}
    <div className="grid lg:grid-cols-2 gap-8 mb-12">
      {/* جلسات الأسبوع الحالي */}
